...
:::
::: {.column width="20%"}
![](img/pycharm.png "Pycharm"){fig-align="left" height="80px"}
:::
::::
...
- **Timing:** The market automatically closes after 90 seconds using oTree's standard `timeout_seconds = 90` [see dedicated slide](#timeout).
